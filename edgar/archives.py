"""Service for accessing SEC EDGAR filing archives and directories."""
...
class Archives():
    ...
    ## Overview
    ----
    Provides access to the SEC EDGAR filing archives, including company
    directories, daily and full indexes, feeds, old loads, and virtual
    private reference rooms (VPRR).
    """
    ...
    def get_company_directories(self, cik: str) -> list[dict]:
    ...
    def get_company_directory(self, cik: str, filing_id: str) -> list[dict]:
        """Grabs all the filing directories for a company.
        ...
        url = self.endpoint + f"/data/{cik}/{filing_id}/index.json"
    ...
    def get_feed(self, year: int, quarter: str = None) -> list[dict]:
    ...
    def get_old_loads(self, year: int, quarter: str = None) -> list[dict]:
    ...
    def get_virtual_private_reference_rooms(self) -> list[dict]:
    ...
    def get_virtual_private_reference_room(self, film_number: str) -> list[dict]:
    ...
    def get_daily_indexes(self) -> list[dict]:
    ...
    def get_daily_index(self, year: int, quarter: str = None) -> list[dict]:
    ...
    def get_full_indexes(self) -> list[dict]:
    ...
    def get_full_index(self, year: int, quarter: str = None) -> list[dict]:
